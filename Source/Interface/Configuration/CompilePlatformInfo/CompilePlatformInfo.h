...
#define ERS_TARGET_OS_VERSION "5.15.0-50-generic" // Version of the operating system which ERS is being built for.
...
#define ERS_HOST_OS_VERSION  "5.15.0-50-generic" // Version of the operating system which is compiling ERS.
