...
enum SimulationActions { SIMULATION_NONE, SIMULATION_RESET, SIMULATION_RUNFOR, SIMULATION_VSDA, SIMULATION_VISUALIZATION_BUILD_MESH, SIMULATION_VISUALIZATION_DRAW_IMAGE };
