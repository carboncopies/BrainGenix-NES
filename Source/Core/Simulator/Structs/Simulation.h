...
struct Simulation {
    ...
    std::vector<Neurons::Neuron> Neurons; /** List of neurons, index is their id. Notice that this takes a Neuron base class object (not BSNeuron and other derivatives). */
