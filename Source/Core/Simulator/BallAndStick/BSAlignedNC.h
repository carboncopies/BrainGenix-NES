...
/**
 * @brief This struct provides the structure representing a ball-and-stick neural circuit.
 * 
 */
struct BSAlignedNC: CoreStructs::NeuralCircuit {
    ...
    std::unordered_map<std::string, 
        std::shared_ptr<CoreStructs::Neuron>> cells;
    ...
    std::vector<std::shared_ptr<BSNeuron>> GetNeuronsByID(std::vector<int> IDList);
