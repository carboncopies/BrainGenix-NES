...
public:
     ...
     */
    GeometryRPCInterface(BG::Common::Logger::LoggingSystem* _Logger, ConcurrentUniquePtrRegistry<Simulation>* _Simulations, API::RPCManager* _RPCManager);

    /**
     * @brief Destroy the GeometryRPCInterface object
     * 
     */
    ~GeometryRPCInterface();
