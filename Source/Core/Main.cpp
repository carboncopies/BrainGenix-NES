...
int main(int NumArguments, char** ArgumentValues) {
    ...
    // Setup RenderPools
    BG::NES::Simulator::VSDA::RenderPool RenderPool(&SystemConfiguration, &Logger, false, 5);
    ...
    BG::NES::Simulator::NetmorphRPCInterface   NetmorphRPCInterface(&Logger, SimulationRPCInterface.GetSimulationVectorPtr(), &APIManager);
