...
public:
    ...
    /**
     * @brief Initializes the ConversionPool with the given number of threads requested.
     * 
     * @param _Logger 
     * @param _NumThreads 
     */
    ConversionPool(BG::Common::Logger::LoggingSystem* _Logger, int _NumThreads = 24);
