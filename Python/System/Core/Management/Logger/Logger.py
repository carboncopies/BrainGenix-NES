...
## Makes a Dir, catches exception if already exists
# This function attempts to make a directory, and if it already exists, skips it.
# *DO NOT CALL THIS*
# @param path path to check if directory exists
def TryMakeDir(path): 
...
class SysLog(): 
    ...
    def __init__(self, SystemConfiguration:dict): 
    ...
    ## Colorizes A String Of Text
    # @param Text Text to color
    # @param Color Color to add to text
    def ColorizeText(self, Text, Color):
    ...
    def Log(self, Message:str, Level:int=0):
        ...
        ## Reformat Log For Human Readability
    ...
    ## Create Logger Shutdown Command
    def CleanExit(self):
