...
class SystemTelemetryManager(): # Manages the system telemetry leader class #
    ...
    def StartSystem(self): # Called During Startup #
        ...
        # Instantiate #
        self.SysTelFollower = Follower(Logger=self.Logger, SystemConfiguration=self.SystemConfiguration, Zookeeper=self.Zookeeper)
    ...
    def TransitionLeader(self): # Transitions The System To Follower Mode #
        ...
        # Instantiate #
        self.SysTelLeader = Leader(Logger=self.Logger, SystemConfiguration=self.SystemConfiguration, Zookeeper=self.Zookeeper)
