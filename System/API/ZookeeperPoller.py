...
class PollWatcher(): # Watches Zookeeper to check for new API requests #
    ...
    def ConnectionHandler(self, TargetConnection, PollingInterval:float = 0.005): # Executes Functions For A Given Command #
        ...
        while True:
            ...
            try:
                if self.Zookeeper.ZookeeperConnection.get(f'/BrainGenix/API/Connections/{TargetConnection}')[0] != CommandData:
            ...
            if (CommandData != b'') and (CommandData != None) and (CommandData.decode('utf-8') != Output):
    ...
    def Version(self, ArgumentsDictionary): # Provide Versioning Information #
        ...
        return '''
    BrainGenix-Development Version 0.0.4
    '''
