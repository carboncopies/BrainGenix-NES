...
namespace ImGui
{
    ...
    IMGUI_API void          HelpMarker(const char* Text); // MODIFICATION OF IMGUI LIBRARY!!!!!!!!!!!!!!!!!!
    ...
    IMGUI_API bool          DragFloat3(const char* label, float v[3], float v_speed, float colors[9], float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", ImGuiSliderFlags flags = 0); // MODIFIED BY ERS DEV TEAM TO ALLOW FOR RGB COLORD DRAG FLOAT
    ...
    IMGUI_API bool          DragScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, float v_speed, float colors[], const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0); // MODIFIED BY ERS TEAM
